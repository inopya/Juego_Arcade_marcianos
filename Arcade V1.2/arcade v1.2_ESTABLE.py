...
pausarPartida = False # False, guego activo
...
def CargarDatosNivel():
    ...
    jefe_SIZE = int(ENEMIGO_MinSIZE + (ENEMIGO_MaxSIZE - ENEMIGO_MinSIZE)/2)
    velocidadJefe = 6
    lista_cosas_buenas = []
    i = 0
...
##                moveUp = False
                moveDown = True
            if event.key == K_p:
                pausarPartida = not pausarPartida
            if event.key == K_a:
